...
AddCondition(2, cf_trigger,"錯誤事件","基本事件","連線錯誤","接受Server端傳送的錯誤","OnError");
...
AddExpression(11,ef_return_any,"1:1區紀錄","遊戲參數","LobbyHistory1","1:1區紀錄");
AddExpression(12,ef_return_any,"1:2區紀錄","遊戲參數","LobbyHistory2","1:2區紀錄");
AddExpression(13,ef_return_any,"1:5區紀錄","遊戲參數","LobbyHistory3","1:5區紀錄");
AddExpression(14,ef_return_any,"1:10區紀錄","遊戲參數","LobbyHistory4","1:10區紀錄");
AddExpression(15,ef_return_any,"1:1區狀態","遊戲參數","LobbyStatus1","1:1區狀態");
AddExpression(16,ef_return_any,"1:2區狀態","遊戲參數","LobbyStatus2","1:2區狀態");
AddExpression(17,ef_return_any,"1:5區狀態","遊戲參數","LobbyStatus3","1:5區狀態");
AddExpression(18,ef_return_any,"1:10區狀態","遊戲參數","LobbyStatus4","1:10區狀態");
AddExpression(19,ef_return_any,"遊戲局數","遊戲參數","GameSet","遊戲局數");
AddExpression(20,ef_return_any,"遊戲局數","遊戲參數","Odds","遊戲局數");
ACESDone();
